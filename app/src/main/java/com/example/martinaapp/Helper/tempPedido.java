...
public class tempPedido {
    ...
    public tempPedido(Context appContext) {
    ...
    public ArrayList<Productos> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Productos> playerList =  new ArrayList<Productos>();

        for(String jObjString : objStrings){
            Productos player  = gson.fromJson(jObjString,  Productos.class);
    ...
    public void putListObject(String key, ArrayList<Productos> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Productos player: playerList){
